  ...
  return (
    <div className="relative bg-gradient-to-r from-blue-400 to-indigo-700 dark:from-gray-800 dark:to-gray-900 my-16 text-center text-white py-24 shadow-lg">
      ...
      <form className="flex items-center justify-center mt-5 ">
        <input className="w-1/3 p-4 rounded-l-full shadow-md text-black overflow-hidden dark:text-gray-100 dark:placeholder:bg-gray-500 " placeholder="search courses"></input>
        <button className="p-4 bg-blue-800 rounded-r-full shadow-md  hover:scale-105 focus:ring-4 focus:ring-blue-300 dark:hover:bg-blue-800">
          Search
        </button>
      </form>
